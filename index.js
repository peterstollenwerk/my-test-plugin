...
exports.default = _default;
        var $abfbdd = exports.default || module.exports;
      
      if (typeof $abfbdd === 'function') {
        $abfbdd = $abfbdd.options;
      }
    
        /* template */
        Object.assign($abfbdd, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$abfbdd', $abfbdd);
          } else {
            api.reload('$abfbdd', $abfbdd);
          }
        }
